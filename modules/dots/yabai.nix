{ pkgs, inputs, ... }: {
  services.yabai = {
    ...
    config = {
      ...
      active_window_border_color = "0xFF${inputs.themes.dracula.hex.purple}";
      normal_window_border_color = "0xFF${inputs.themes.dracula.hex.comment}";
      insert_feedback_color = "0xFF${inputs.themes.dracula.hex.green}";
    };
    extraConfig = ''
